function [Standards, WB_list] = DMOsFromINDIP_INDIPmrk(Data, stride_list, n_min, max_break,  rMrkL, lMrkL, headerTraj, fs, ...
...
%             mrk_now1 = strcat(side,'HEEL'); mrk_now2 = strcat(side,'TOE');
%             mrkTraj = (headerTraj.(mrk_now1)+headerTraj.(mrk_now2))/2; % mid-point of the foot
