function [IC, FC, R_align, MrkL, foreFoot, checkOutputs] = GE_Zeni_v4_INDIP(Data, headerTraj,time, FootMrk, side, fs, mrkDyn, fig, TurnsNotDec, MrkGaps, InclinationFootStatic, InclinationFootGait)

%% New version adapted for a mrk placed on the foot INDIP unit
%%
...
for i = 1:length(zML)
    ...
    INDIP_l(i,:) = (R_align(:,:,i)'*(Data.(headerTraj).(strcat(side,'INDIP'))(i,:) - t(i,:))')';
end
MrkL.HEEL = HEEL_l;
MrkL.TOE = TOE_l;
MrkL.COM = t;
