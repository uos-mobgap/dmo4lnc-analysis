function [stride_list] = strideDet_eScience_mrk (GEs, max_st, min_st, min_sl,  max_h, Data, headerTraj, fs, mrkToUse)
...
if (~isempty(rHS)||size(rHS,1)>1) && (~isempty(lHS)||size(lHS,1)>1)
    ...
    for  i = 1:size(rHS,1)-1
        if strcmp(mrkToUse,'REF')
            if rHS(i,2)==1 && rHS(i+1,2)==1
                mrkToUse_Now1 = 'HEEL';
                mrkToUse_Now2 = 'HEEL';
%             elseif rHS(i,2)==1 && rHS(i+1,2)==0
%                 mrkToUse_Now1 = mrkToUse;
%                 mrkToUse_Now2 = 'HEEL';
%             elseif rHS(i,2)==0 && rHS(i+1,2)==1
%                 mrkToUse_Now2 = mrkToUse;
%                 mrkToUse_Now1 = 'HEEL';
            else
                mrkToUse_Now1 = mrkToUse;
                mrkToUse_Now2 = mrkToUse;
        ...
        rL = [rL; sqrt((Data.(headerTraj).(strcat('R', mrkToUse_Now1))(rHS(i+1,1),1)-Data.(headerTraj).(strcat('R', mrkToUse_Now2))(rHS(i,1),1))^2+...
            (Data.(headerTraj).(strcat('R', mrkToUse_Now1))(rHS(i+1,1),2)-Data.(headerTraj).(strcat('R', mrkToUse_Now2))(rHS(i,1),2))^2+...
            (Data.(headerTraj).(strcat('R', mrkToUse_Now1))(rHS(i+1,1),3)-Data.(headerTraj).(strcat('R', mrkToUse_Now2))(rHS(i,1),3))^2)];
    ...
    for  i = 1:size(lHS,1)-1
        if strcmp(mrkToUse,'REF')
            if lHS(i,2)==1 && lHS(i+1,2)==1
                mrkToUse_Now1 = 'HEEL';
                mrkToUse_Now2 = 'HEEL';
%             elseif lHS(i,2)==1 && lHS(i+1,2)==0
%                 mrkToUse_Now1 = mrkToUse;
%                 mrkToUse_Now2 = 'HEEL';
%             elseif lHS(i,2)==0 && lHS(i+1,2)==1
%                 mrkToUse_Now2 = mrkToUse;
%                 mrkToUse_Now1 = 'HEEL';
            else
                mrkToUse_Now1 = mrkToUse;
        ...
        lL = [lL; sqrt((Data.(headerTraj).(strcat('L', mrkToUse_Now1))(lHS(i+1,1),1)-Data.(headerTraj).(strcat('L', mrkToUse_Now2))(lHS(i,1),1))^2+...
                            (Data.(headerTraj).(strcat('L', mrkToUse_Now1))(lHS(i+1,1),2)-Data.(headerTraj).(strcat('L', mrkToUse_Now2))(lHS(i,1),2))^2+...
                            (Data.(headerTraj).(strcat('L', mrkToUse_Now1))(lHS(i+1,1),3)-Data.(headerTraj).(strcat('L', mrkToUse_Now2))(lHS(i,1),3))^2)];
