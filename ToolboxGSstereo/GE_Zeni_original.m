function [IC, FC, R_align, MrkL, foreFoot, checkOutputs] = GE_Zeni_original(Data, headerTraj,time, FootMrk, side, fs, mrkDyn, fig, TurnsNotDec, MrkGaps, InclinationFootStatic, InclinationFootGait)
...
if ~isempty(IC) && ~isempty(FC)
    ...
    %% Check if an IC has been perfomed forefoot
